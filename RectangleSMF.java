...
public class RectangleSMF extends Application {
          ...
          public void start(Stage stage) throws Exception  {
                    ...
                    pol = new Polygon(200,0,100,100*Math.sqrt(3),300,100*Math.sqrt(3));
                    circle = new ExpandedCircle(-100, -100, 10);
                    cir = new ExpandedCircle(200, 200, 200);
                    vec = new Vector2(0, 0);
                    root = new Pane();
                    root.getChildren().addAll(pol, circle);
          ...
          private void setVector(MouseEvent event) {
                    ...
                    Vector2 smfPosition = SMF.getSupportMapping(
                              pol, new Vector2(this.endX-this.startX, this.endY-this.startY)
                    );
                    circle.setCenterX(smfPosition.x);
                    circle.setCenterY(smfPosition.y);
          }
